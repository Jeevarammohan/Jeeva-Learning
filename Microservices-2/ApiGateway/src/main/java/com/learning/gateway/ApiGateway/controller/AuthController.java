package com.learning.gateway.ApiGateway.controller;

import com.learning.gateway.ApiGateway.model.AuthResponse;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> login(@RegisteredOAuth2AuthorizedClient("okta") OAuth2AuthorizedClient  client,
        ...
        authResponse.setExpiresIn(client.getAccessToken().getExpiresAt().getEpochSecond());
